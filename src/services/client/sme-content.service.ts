...
export const smeContentService = {
  /**
   * POST /api/sme-content/appointments
   * Saves the Calendly appointment details along with the selected tiers
   * to the backend so the team knows when the session was booked.
   */
  ...
  /**
   * GET /api/sme-content/appointments/:id
