          ...
          <TableHeader className="border-y border-gray-100 dark:border-gray-800">
            <TableRow>
              ...
              {[
                ...
                return (
                  <TableCell key={col} isHeader className="px-3 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 whitespace-nowrap">
                    {is_sortable ? (
                      <button
              ...
              rows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="whitespace-nowrap px-3 py-3 font-mono text-xs font-medium text-gray-700 dark:text-gray-300">
                      <Link
                    ...
                    <TableCell className="whitespace-nowrap px-3 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
