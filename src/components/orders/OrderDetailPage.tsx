      ...
      <div className="rounded-2xl border border-gray-200 bg-white px-4 pb-6 pt-4 dark:border-gray-800 dark:bg-white/3 sm:px-6 sm:pt-6">
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {product_type === "new_content" && (
              <Link
                href={`/new-content/orders/${order_id}/intake`}
                className="inline-flex items-center gap-1.5 rounded-lg border border-blue-200 bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 hover:bg-blue-500 hover:text-white dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-300 dark:hover:bg-blue-500 dark:hover:text-white transition-colors"
              >
                <KeywordsIcon />
                View Keywords
              </Link>
