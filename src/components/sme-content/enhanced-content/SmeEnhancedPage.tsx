...
import SmeEnhancedHeader from "./SmeEnhancedHeader";
...
const SmeEnhancedPage: React.FC = () => {
  ...
  const total = useMemo(() => {
    return sme_enhanced_tiers.reduce((sum, tier) => {
...
export default SmeEnhancedPage;
