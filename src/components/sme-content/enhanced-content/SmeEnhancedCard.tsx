...
const SmeEnhancedCard: React.FC<SmeEnhancedCardProps> = ({
  tier,
  quantity,
  onQuantityChange,
}) => {
  ...
  return (
    ...
    >
      ...
      {/* Label */}
      <h3 className="mb-3 pr-8 text-sm font-semibold text-gray-800 dark:text-white/90">
        {tier.label}
      </h3>
...
export default SmeEnhancedCard;
