...
const STATUS_OPTIONS: StatusOption[] = [
  {
    value: "new_request",
    label: "New Request",
    description: "Fresh order received, awaiting team review and assignment.",
    icon: (
    ...
    bg_active: "bg-teal-50 dark:bg-teal-500/10",
    border: "border-gray-200 dark:border-gray-700",
    border_active: "border-teal-300 dark:border-teal-500/40",
    text: "text-teal-700 dark:text-teal-400",
    badge_bg: "bg-teal-100 dark:bg-teal-500/20",
