...
import type { ReportTable, ReportRow, ReportRowStatus, UpdateReportRowPayload } from "@/types/admin/order-report";
...
export default function ReportTableCard({ table, onEditRow }: ReportTableCardProps) {
                    ...
                    <td colSpan={11} className="px-4 py-10 text-center">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-sm text-gray-400 dark:text-gray-500">
                          No placements found for this order item.
                        </p>
                      </div>
                    </td>
                  </tr>
